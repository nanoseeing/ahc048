...
DicisionAction construct_from_immediateinfo(vector<ImmediateInfo> &best_info, vector<int> &partition_positions) {
...
class DicisionActionPerResult {
  public:
    ...
    DicisionActionPerResult(State &state, Input &input, vector<int> &partition_positions) {
        this->construct(state, input, partition_positions);
    }

    void construct(State &state, Input &input, vector<int> &partition_positions) {
...
DicisionAction dicision_action(Input &input, State &state, ColorMixer &mixer, double obj_turn, vector<int> &partition_positions) {
    ...
    DicisionActionPerResult per_result = DicisionActionPerResult(state, input, partition_positions);
    ...
    DicisionAction action_result = construct_from_immediateinfo(best_info, partition_positions);
    return action_result;
}
